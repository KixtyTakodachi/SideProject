	...
	return (
		<div className="login_bg">
			<div className="login_form">
				<h1 className="login_title">{ru_kz_dict.vhod[language]}</h1>
				...
				>
					<Form.Item
						name="login"
						rules={[{ required: true, message: ru_kz_dict.vvedite_login[language] }]}
					>
						<Input className="form_input" prefix={<UserOutlined />} placeholder="Логин" />
					</Form.Item>
					<Form.Item
						name="password"
						rules={[{ required: true, message: ru_kz_dict.vvedite_parol[language] }]}
					>
					...
					<Button htmlType="submit" type="primary" className="form_button">
						{ru_kz_dict.vhod[language]}
					</Button>
				</Form>
				<div className="login_language">
					<div
						className={['login_language_item', language === 'ru' ? 'language_active' : ''].join(
							' ',
						)}
					...
					/
					<div
						className={['login_language_item', language === 'kz' ? 'language_active' : ''].join(
							' ',
						)}
